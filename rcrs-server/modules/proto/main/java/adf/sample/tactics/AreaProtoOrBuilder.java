...
public interface AreaProtoOrBuilder extends
   ...
   */
  java.util.List<adf.sample.tactics.EdgeProto> 
      getEdgesList();
  /**
   * <code>repeated .simpleRCRS.EdgeProto edges = 5;</code>
   */
  adf.sample.tactics.EdgeProto getEdges(int index);
  /**
   * <code>repeated .simpleRCRS.EdgeProto edges = 5;</code>
   */
  int getEdgesCount();
   ...
   * <code>repeated .simpleRCRS.EdgeProto edges = 5;</code>
   */
  java.util.List<? extends adf.sample.tactics.EdgeProtoOrBuilder> 
      getEdgesOrBuilderList();
  /**
   * <code>repeated .simpleRCRS.EdgeProto edges = 5;</code>
   */
  adf.sample.tactics.EdgeProtoOrBuilder getEdgesOrBuilder(
      int index);
